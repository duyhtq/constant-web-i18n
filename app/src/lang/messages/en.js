export default {
  ...
  home: {
    ...
    whatDesc1:
      'You are completely insured by the FDIC and US treasury. No matter how much Constant you have.',

    whatTitle2: 'By the US Government',
    whatTitle3: 'Free transfers',
    whatDesc0:
      'No matter where in the world you are, your Constant keeps the value of the USD. And you can withdraw in your local currency anytime.',

    whatDesc2:
      'Keep your money safe with a chartered, regulated, US financial institution, subject to frequent audits.',
    whatDesc3:
      'No limits, no fees. Constant moves instantly from your account to anyone, anywhere in the world. For free.',
