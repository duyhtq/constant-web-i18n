export default {
  ...
  newHome: {
    ...
    banner: {
      ...
      borrow: {
        ...
        cap: '          <div class="row">            <div class="col">              Interest rate              <strong>From {rate}%</strong>            </div>            <div class="col">              Loan term              <strong>1-6 <span>months</span></strong>            </div>          </div>          <p class="clearBottom text-left">            Borrow against<br/>{numCollateral}+ cryptocurrencies          </p>        ',
        btn: 'Explore'
      }
    }
  },
    ...
    constantLoan: {
      intro: {
        content: `
            ...
            <p class="h1">Combine {numCollateral}+ cryptos as collateral.</p>
      ...
      what: {
        ...
        data: {
          0: {
            caption: 'Withdraw in fiat or crypto',
      ...
      howItWorks: {
        ...
        data: {
          ...
          2: {
            caption: '{step}. Deposit your collateral',
          ...
          3: {
            caption: '{step}. Withdraw your loan',
          ...
          4: {
            caption: '{step}. Repay at any time',
  ...
  support: {
    newTitle: `      <h6>Questions? Let's get on a call.</h6>      <h6>Set up a time <a href="/call-us">here</a>.</h6>`
  },
  home1: {
    lendingSection: {
      form: {
  ...
  deposit: {
    ...
    contentHtml: '      <p>Do more with your money</p>      <h1>Enjoy 50x better interest<br/>than a savings account<sup>*</sup>.</h1>      <p/>      <p>Earn {interest}% APY through decentralized lending and liquidity pools. You deposit, we lend on your behalf, and you keep the interest. Unlimited free withdrawals and no fees. Grow your money without locking it in.</p>      <p class="reference"><sup>*</sup>Comparison based on data from ValuePenguin.</p>    ',
  ...
  yourReferral: {
    ...
    terms: {
      ...
      normalNonUS: `        <h3 class="semiBold">Terms and Conditions</h3>        <ol><li><p>Your earning is paid after your referee makes the first fiat deposits.</p></li>          <li><p>Your referral interest is calculated on the interest your friends earn with our Flex account.</p></li>          <li><p>Referral interest is paid to you by Constant and does not deduct from your friends’ earned Flex interest.</p></li>          <li>            <p>The amount you earn depends on how your friends use the platform:</p>            <p>You earn {referralFlexReward}% of your friends’ earned Flex interest during their first year. We pay this interest every second that your friends are earning. (Your friends can also refer others to boost your and their earnings, too).</p>          </li>          <li><p>You can invite as many friends as you like.</p></li>          <li><p>Your referral earnings are paid in USD, directly into your Constant account.</p></li>          <li><p>The maximum you can earn is $1,000,000.</p></li>          <li><p>You can’t self-invite by creating multiple accounts. If we detect such activity, all referrals and earnings (if any) will be forfeit.</p></li>          <li><p>When 365 days have passed following your friend’s sign-up, you’ll no longer earn on their Flex interest. For example, on the 366th day, you won't earn interest but on the 365th one you will.</p></li>          <li><p>For friends referred before the effective date (2020/02/17), you’ll earn on their Flex transactions after the effective date only.</p></li>          <li><p>Constant reserves the right to change the terms of the referral program at any time due to changing market conditions, risk of fraud, or any other factors we deem relevant.</p></li>        </ol>        <p class="bold effective">Effective as of 2020/02/17 00:00 AM (GMT+0)</p>      `
    }
  },
  landingProReferral: {
    inviteEmail: {
