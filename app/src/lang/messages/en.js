export default {
  ...
  me: {
    ...
    getStarted: {
      steps: {
        verifyEmail: 'Step 1: Verify email',
        kyc: 'Step 2: Submit KYC',
        bank: 'Step 3: Link your bank account',
      },
  ...
  newHome: {
    ...
    howItWorks: {
      title: 'How it works',
      desc: 'MyConstant connects investors with borrowers to do business together. Crypto collateral and buy-back guarantees protect investors’ funds while our custodial partner safely manages the movement of funds and collateral.',
      content: {
        '0': {
          title: 'Investors',
