...
`,
    ...
    constantLoan: {
      ...
      listApplications: {
        ...
        minIsolateMessage: `Min Amount: {amount} will set your Loan's Collateral Value at approximately {rate}%.`,
        maxIsolateMessage: `Max Amount: {amount} will set your Credit Lines's Collateral Value at approximately {rate}%.`,
        ...
        errorIsolateNotEnought: 'Your Collateral Balance does not meet the minimum amount to set multi-collateral to isolated.',
        depositFrom: {
          title: 'Make more deposit for your collateral',
          amount: 'Amount',
          requiredAmount: 'Amount is required!',
